...
class QCRun(Base):
    ...
    pipeline_status: Mapped[str] = mapped_column(String(50), default="QUEUED", nullable=False)
    current_step: Mapped[Optional[str]] = mapped_column(String(50), default="QUEUED", nullable=True)
